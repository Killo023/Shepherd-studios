    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4">
              Modern creative studio delivering exceptional digital experiences.
            </p>
            {/* Social Links */}
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>
                ...
                <a href="mailto:hey@shepherdstudios.co.za" className="hover:text-white transition-colors">
                  hey@shepherdstudios.co.za
                </a>
              </li>
              <li>
                <span className="font-medium text-gray-300">Website:</span>{' '}
                <a href="https://www.shepherdstudios.co.za" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>&copy; {currentYear} Shepherd Studios. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
